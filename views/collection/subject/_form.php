...
<fieldset>
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'collections'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'collections',array('size'=>23,'maxlength'=>23)); ?>
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'collection_all'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'collection_all',array('size'=>21,'maxlength'=>21)); ?>
			<?php echo $form->error($model,'collection_all'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>
