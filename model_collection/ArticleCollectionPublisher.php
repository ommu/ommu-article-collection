...
class ArticleCollectionPublisher extends CActiveRecord
{
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('ArticleCollectionPublisher_sort'))
		...
		if(count($this->defaultColumns) == 0) {
			...
			*/
			...
			if(!Yii::app()->getRequest()->getParam('type')) {
				$this->defaultColumns[] = array(
					'name' => 'publish',
					'value' => 'Utility::getPublish(Yii::app()->controller->createUrl("publish", array("id"=>$data->publisher_id,\'plugin\'=>\'collection\')), $data->publish, 1)',
					'htmlOptions' => array(
						'class' => 'center',
					),
